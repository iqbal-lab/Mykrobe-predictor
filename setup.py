...
setup(
    ...
    packages=['atlas', 'atlas.cmds', 'atlas.typing', 'atlas.typing.typer', 'atlas.typing.models', 'atlas.schema', 'atlas.schema.models', 'atlas.stats', 'atlas.cortex', 'atlas.metagenomics'],

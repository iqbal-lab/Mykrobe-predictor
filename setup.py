...
setup(
    name='mykrobe',
    version='0.3.0.1',
    packages=['atlas', 'atlas.cmds', 'atlas.pheno', 'atlas.typing', 'atlas.typing.typer', 'atlas.typing.models', 'atlas.schema', 'atlas.schema.models', 'atlas.stats', 'atlas.cortex', 'atlas.metagenomics'],
    ...
    package_data={'atlas': ['data/predict/*/*','data/predict/taxon_coverage_threshold.json',
                            'data/phylo/*',

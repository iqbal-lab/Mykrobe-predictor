...
CFLAGS_PREDICTOR_TESTS = -I$(IDIR_CORE) -I$(IDIR_PREDICTOR_CORE) -I$(IDIR_PREDICTOR_TESTS) -I$(IDIR_BASIC) -I$(IDIR_BASE_ENCODING) -I$(IDIR_HASH) -I$(IDIR_PREDICTOR) -I$(IDIR_PREDICTOR_CORE) $(TEST_LIBINCS)

...
tell application "Finder"
  tell disk appName
    ...
    set background picture of theViewOptions to POSIX file ("/Volumes/" & appName & "/.background/background.tiff")
    set position of item (appName & ".app") of container window to {175, 100}
    set position of item "Applications" of container window to {325, 100}
